          ...
          <table-header
            ...
            :menus="[
              { shortcut: true,
                ...
                icon: 'add',
                hidden:!$app.can('positions-create'),
...
export default {
  ...
  data () {
    return {
      ...
      TABLE: {
        show:false,
        resource:{
          api: '/api/v1/references/positions',
          uri: '/admin/references/positions',
        },
        columns: [
  ...
  computed:{
    isCanUpdate(){
      return this.$app.can('positions-update')
    },
    isCanDelete(){
      return this.$app.can('positions-delete')
    },
  },
  mounted () {
